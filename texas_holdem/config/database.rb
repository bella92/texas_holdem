...
database_name = case Padrino.env
  when :development then 'texas_holdem_development'
  when :production  then 'texas_holdem_production'
  when :test        then 'texas_holdem_test'
end
...
#     sessions:
#       default:
#         database: texas_holdem_development
#         hosts:
#           - localhost:27017
#   production:
#     sessions:
#       default:
#         database: texas_holdem_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
